(function (global, factory) {
    ...
    */
        ...
        function Formik(props) {
            ...
            _this.runValidations = function (values) {
                ...
                return Promise.all([
                    ...
                    var combinedErrors = deepmerge_1.all([
                        fieldErrors,
                        schemaErrors,
                        handlerErrors,
                    ]);
        ...
        Formik.prototype.runFieldLevelValidations = function (values) {
            ...
            var fieldValidations = fieldKeysWithValidation.length > 0
                ? fieldKeysWithValidation.map(function (f) {
                    return _this.runSingleFieldLevelValidation(f, values[f]).then(function (x) { return x; }, function (e) { return e; });
                })
    ...
    function isEqualExceptForKey(a, b, path) {
        return reactFastCompare(setIn(a, path, undefined), setIn(b, path, undefined));
    }
    var FastFieldInner = (function (_super) {
        ...
        function FastFieldInner(props) {
            ...
            warning_1(!(props.component && children && isFunction$1(children)), 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.');
        ...
        FastFieldInner.prototype.componentDidUpdate = function (prevProps, _state) {
            ...
            if (!reactFastCompare(nextFieldValue, prevFieldValue)) {
                this.setState({ value: nextFieldValue });
            }
            if (!reactFastCompare(nextFieldError, prevFieldError)) {
